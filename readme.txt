=== Push Notification ===
Contributors: s2krish, cyberkishor 
#Donate link: http://it.ontreat.com/donate/
...
A plugins that uses the ACS Notification push API to send push notification from the new post creation.
